...
export class KeybindService {
  ...
  constructor(
    ...
    const keybinds = [
      {
        event: 'party-personal-networth',
        title: 'Report personal net worth to party',
        keys: 'Ctrl+C'
      },
      {
        event: 'party-summary-networth',
        title: 'Report summarized net worth to party',
        keys: 'Ctrl+D'
      }
    ];
    this.electronService.ipcRenderer.send('keybinds-update', keybinds);
